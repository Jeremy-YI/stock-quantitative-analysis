...
install: venv
	...
	.venv/bin/python -m pip install -i https://pypi.tuna.tsinghua.edu.cn/simple -e packages/indicators -e packages/datasource -e packages/market -e packages/strategies -e packages/backtest -e packages/scheduler -e packages/research
