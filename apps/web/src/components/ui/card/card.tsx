...
const CardContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn('p-4 pt-0 mobile-portrait:p-5 mobile-portrait:pt-0', className)}
      {...props}
    />
  ),
)
...
const CardFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        'flex flex-wrap items-center gap-2 p-4 pt-0 mobile-portrait:p-5 mobile-portrait:pt-0',
        className,
      )}
      {...props}
    />
